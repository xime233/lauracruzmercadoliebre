...
app.listen(3000, () => { console.log("Código funcionando y escuchando en el puerto 3000;  igual recorda de colocar -npm run startcode- y despues coloca -localhost/3000- en el navegador por favor.")})